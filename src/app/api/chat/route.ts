  ...
  try {
    ...
    return createDataStreamResponse({
      execute: async (dataStream) => {
        ...
        // Allow up to 10 explicitly mentioned workflows; do not hard-gate tool availability
        ...
        // Let the model take as many steps as it needs (we cap maxSteps globally below)
